<?php $this->_tpl_include('overall_header.html'); if (! $this->_rootref['S_USER_LOGGED_IN']) {  ?>
	<br clear="all" />
...
<?php } if ($this->_rootref['U_MCP']) {  ?>
	...
	<br clear="all" /><br />
<?php } if ($this->_rootref['S_USER_LOGGED_IN']) {  } $this->_tpl_include('forumlist_body.html'); ?>
...
<?php $this->_tpl_include('breadcrumbs.html'); if ($this->_rootref['S_DISPLAY_ONLINE_LIST']) {  ?>
	...
	<?php } ?>
		<td class="row1" width="100%"><span class="genmed"><?php echo (isset($this->_rootref['TOTAL_USERS_ONLINE'])) ? $this->_rootref['TOTAL_USERS_ONLINE'] : ''; ?><br /><?php echo (isset($this->_rootref['RECORD_USERS'])) ? $this->_rootref['RECORD_USERS'] : ''; ?><br /><br /><?php echo (isset($this->_rootref['LOGGED_IN_USER_LIST'])) ? $this->_rootref['LOGGED_IN_USER_LIST'] : ''; ?></span></td>
	</tr>
	<?php if ($this->_rootref['LEGEND']) {  ?>
		<tr>

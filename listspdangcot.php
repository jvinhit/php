...
<title>Trang list dang cot</title>
</head>
...
echo"<table width='550' border='1' align='center' cellpadding='0' cellspacing='0' bgcolor='#FFFF99' bordercolor='#FFCCCC' style='border-collapse:collapse'>
  <tr>
    <td height='35' colspan='3' align='center' bgcolor='#FFFF66'>THÔNG TIN SẢN PHẨM</td>
  </tr>";
  $stt = 0;
  ...
  echo"<tr>";
    ...
    echo"<td width='400' valign='top' style='padding-left:5px;padding-top:5px;' align='center'><font color='#FF0000'><b>Tên laptop:</b></font> $row[1] <br> <font color='#0000CC'>Hãng laptop:</font> $row[2]<br><font color='#FF00FF'> Loại laptop:</font> $row[3] - $row[4] - $row[5]<br/><img src='laptop/$row[0]' width='150' height='100'></td>";
	$stt++;
	if($stt % 3==0)
  echo"</tr>";
  }
...
for($i = 1; $i <= $sotrang;$i++)
{
	...
	{
		?>
        <a href="listspdangcot.php?p=<?php echo $i;    ?>"><?php  echo $i;   ?></a>
